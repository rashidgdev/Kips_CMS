...
urlpatterns = [
    ...
    path('entries/<int:entry_id>/join/', views.join_offering, name='join-offering'),
    path('entries/<int:entry_id>/join/<int:offering_id>/remove/', views.unjoin_offering, name='unjoin-offering'),
